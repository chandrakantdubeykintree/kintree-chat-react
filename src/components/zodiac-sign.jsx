...
export default function ZodiacSignList() {
        ...
        >
          ...
          >
            <Link
              ...
              to={`/astrology/zodiac-sign/${sign.name}/${encryptId(sign.id)}`}
            >
  ...
  return (
    <Card className="rounded-2xl py-6 px-2 md:px-6">
      <div className="text-[18px] font-semibold mb-6">{t("zodiac_sign")}</div>
